...
# Jika kepercayaan di bawah nilai ini, dianggap bukan gambar kulit atau tidak meyakinkan
...
def predict():
    ...
    try:
        ...
        # Jika confidence di bawah threshold, kita anggap bukan gambar kulit yang relevan
        if confidence < CONFIDENCE_THRESHOLD:
            return jsonify({
                ...
                "confidence": round(confidence, 3) # Tetap tampilkan confidence untuk debugging/informasi
            }), 200 # Menggunakan 200 karena ini adalah hasil dari prediksi, bukan error server
        
        # Jika confidence memenuhi batas, kembalikan hasil prediksi normal
        result = {
        ...
        # Menangani error umum seperti format gambar tidak valid
