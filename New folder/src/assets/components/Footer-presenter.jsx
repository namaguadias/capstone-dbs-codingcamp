    ...
    <footer className="bg-blue-600 text-white py-10 px-6 mt-10 rounded-lg">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Tentang Kami</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Karier</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Hubungi Kami</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Tim Editorial</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Langganan</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>SkinProtect Corporate</a>
        </div>

        {/* Column 2 */}
        <div className="flex flex-col space-y-3">
          <h3 className="font-bold text-lg mb-2">Lainnya</h3>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Syarat & Ketentuan</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Privasi</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Iklan</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Gabung di Tim Dokter</a>
          <a href="#" className="hover:underline font-medium" style={{ color: 'white' }}>Daftarkan Rumah Sakit Anda</a>
        </div>
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex space-x-4 mb-4">
            <a href="#" aria-label="Facebook" className="bg-white text-blue-600 rounded-full p-2 hover:bg-gray-200">
              {socialIcons.facebook}
            </a>
            <a href="#" aria-label="Twitter" className="bg-white text-blue-600 rounded-full p-2 hover:bg-gray-200">
              {socialIcons.twitter}
            </a>
            <a href="#" aria-label="LinkedIn" className="bg-white text-blue-600 rounded-full p-2 hover:bg-gray-200">
              {socialIcons.linkedin}
            </a>
            <a href="#" aria-label="Instagram" className="bg-white text-blue-600 rounded-full p-2 hover:bg-gray-200">
              {socialIcons.instagram}
            </a>
            <a href="#" aria-label="YouTube" className="bg-white text-blue-600 rounded-full p-2 hover:bg-gray-200">
              {socialIcons.youtube}
            </a>
          </div>
