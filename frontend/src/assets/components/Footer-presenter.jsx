...
const socialIcons = {
  facebook: (
    <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true"> {/* Ukuran ikon sedikit disesuaikan */}
    ...
    <footer className="bg-slate-800 text-slate-300 pt-12 pb-8 px-4 sm:px-6 lg:px-8 mt-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Kolom 1: SkinSights */}
          <div>
            <h3 className="text-base font-semibold text-white tracking-wider uppercase mb-4">SkinSights</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white transition-colors duration-200">Tentang Kami</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Karier</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Hubungi Kami</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Tim Editorial</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Langganan</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">SkinProtect Corporate</a></li>
            </ul>
          </div>

          {/* Kolom 2: Lainnya */}
          <div>
            <h3 className="text-base font-semibold text-white tracking-wider uppercase mb-4">Lainnya</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white transition-colors duration-200">Syarat & Ketentuan</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Privasi</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Iklan</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Gabung di Tim Dokter</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Daftarkan Rumah Sakit Anda</a></li>
            </ul>
          </div>

          {/* Kolom 3: Media Sosial & Info */}
          <div>
            <h3 className="text-base font-semibold text-white tracking-wider uppercase mb-4">Terhubung Dengan Kami</h3>
            <div className="flex space-x-3 mb-4">
              <a href="#" aria-label="Facebook" className="text-slate-400 hover:text-white bg-slate-700 hover:bg-sky-500 rounded-full p-2 transition-colors duration-200">
                {socialIcons.facebook}
              </a>
              <a href="#" aria-label="Twitter" className="text-slate-400 hover:text-white bg-slate-700 hover:bg-sky-500 rounded-full p-2 transition-colors duration-200">
                {socialIcons.twitter}
              </a>
              <a href="#" aria-label="LinkedIn" className="text-slate-400 hover:text-white bg-slate-700 hover:bg-sky-500 rounded-full p-2 transition-colors duration-200">
                {socialIcons.linkedin}
              </a>
              <a href="#" aria-label="Instagram" className="text-slate-400 hover:text-white bg-slate-700 hover:bg-sky-500 rounded-full p-2 transition-colors duration-200">
                {socialIcons.instagram}
              </a>
              <a href="#" aria-label="YouTube" className="text-slate-400 hover:text-white bg-slate-700 hover:bg-sky-500 rounded-full p-2 transition-colors duration-200">
                {socialIcons.youtube}
              </a>
            </div>
            <p className="text-sm text-slate-400 mb-1">Bagian dari SkinSights</p>
        ...
        <p className="text-center text-sm text-slate-400">
          Hak Cipta &copy; {new Date().getFullYear()} SkinSights. Semua Hak Dilindungi.
        </p>
      </div>
    </footer>
  );
